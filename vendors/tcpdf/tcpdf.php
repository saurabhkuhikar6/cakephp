...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$serformat = (is_array($format) ? json_encode($format, JSON_INVALID_UTF8_IGNORE) : $format);
	...
	protected function getHtmlDomArray($html) {
		...
		$csstagarray = '<cssarray>'.htmlentities(json_encode($css, JSON_INVALID_UTF8_IGNORE)).'</cssarray>';
	...
	public function serializeTCPDFtagParameters($data) {
		$encoded = urlencode(json_encode($data, JSON_INVALID_UTF8_IGNORE));
